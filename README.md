...
class assignment {
    ...
    public static void main(String[] args) {
        System.out.println("Name:- Sarthak");
        System.out.println("Roll No:-2210997211");
        ArrayList<assignment> employees = new ArrayList<>();
        employees.add(new assignment("Sarthak", 101, 25000));
        employees.add(new assignment("Nitya", 102, 18000));
        employees.add(new assignment("Ridhima", 103, 30000));
        employees.add(new assignment("Shivam", 104, 22000));
        employees.add(new assignment("Navya", 105, 28000));
